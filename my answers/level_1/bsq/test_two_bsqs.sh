...
gcc -Wall -Wextra -Werror bsq.c -o bsq1     // replace file with correct file to compare to
if [ $? -ne 0 ]; then
    echo "Failed to compile bsq1"
    exit 1
fi

gcc -Wall -Wextra -Werror bsqAttempt.c -o bsq2      // replace file with your attempt
if [ $? -ne 0 ]; then
